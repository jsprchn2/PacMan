...
class Ghost(Sprite):
    ...
    def __init__(self, screen, maze, target, spawn_info, sound_manager, ghost_file='ghost-red.png'):
        ...
        self.norm_images = ImageSupervisor(ghost_file, sheet=True, position_offset=[(0, 0, 32, 32), (0, 32, 32, 32)],
                                           resize=(self.maze.block_size, self.maze.block_size), delay_animate=250)
        self.blue_images = ImageSupervisor('ghost-ppellet.png', sheet=True, position_offset=[(0, 0, 32, 32), (0, 32, 32, 32)],
                                           resize=(self.maze.block_size, self.maze.block_size), delay_animate=150)
        self.blue_warnings = ImageSupervisor('ghost-ppellet-warn.png', sheet=True, position_offset=[(0, 0, 32, 32),(0, 32, 32, 32)],
                                             resize=(self.maze.block_size, self.maze.block_size), delay_animate=150)
        self.eyes = ImageSupervisor('ghost-eyes.png', sheet=True, position_offset=[(0, 0, 32, 32), (32, 0, 32, 32), (0, 32, 32, 32), (32, 32, 32, 32)],
                                    resize=(self.maze.block_size, self.maze.block_size), key=['r', 'u', 'd', 'l'])
